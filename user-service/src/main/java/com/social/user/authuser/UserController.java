...
import com.social.user.file.FileService;
import com.social.user.file.ImageService;
...
public class UserController {
    ...
    public ApiResponse<JpaUserDto> getUserDetailByEmail(@PathVariable("email") String email){
    ...
    public ApiResponse<JpaUserDto> getUserDetailByUniqueName(@PathVariable("uniqueName") String uniqueName){
